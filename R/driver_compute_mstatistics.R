...
#'
#' # Running an M analysis on the GWAS significant variants (p < 5e-08) in the first 10 studies
#' \dontshow{
#' heartgenes44_10studies <- subset(heartgenes214, studies <= 10 & fdr214_gwas46 == 2)
#'  }
#'
#' getmstatistic_results <- getmstatistic(heartgenes44_10studies$beta_flipped, 
#'                                         heartgenes44_10studies$gcse, 
#'                                         heartgenes44_10studies$variants, 
#'                                         heartgenes44_10studies$studies)
...
getmstatistic.default <- function(beta_in, lambda_se_in, study_names_in, 
    ...
    compute_m_results <- compute_m_statistics(beta_in, lambda_se_in, study_names_in, variant_names_in, 
                                              tau2_method, x_axis_increment_in, x_axis_round_in, 
                                              verbose_output)
